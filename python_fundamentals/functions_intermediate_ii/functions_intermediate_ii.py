...
#  of dictionaries, the function loops through each dictionary in the
#  list and prints each key and the associated value. For example, given
#  the following list:
...
# # Version before meeting with teacher # #
